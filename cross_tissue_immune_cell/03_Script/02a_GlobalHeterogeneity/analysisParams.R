...
PATH_EXPERIMENT_REFERENCE = "/mnt/DOSI/PLATEFORMES/BIOINFORMATIQUE/04_PROJECT/scLLM/cross_tissue_immune_cell/01_Reference"
PATH_EXPERIMENT_OUTPUT = "/mnt/DOSI/PLATEFORMES/BIOINFORMATIQUE/04_PROJECT/scLLM/cross_tissue_immune_cell/05_Output"
